...
class PresenterImp constructor(
    private val view: CurrencyContractor.View,
    private val interactor: Interactor
) : Presenter, OnFinishedListener {
    public override fun requestDataFromServer() {
        interactor.getCurrencyData(this)
    }

    public override fun onFinished(`object`: CurrencyResponseObject?) {
